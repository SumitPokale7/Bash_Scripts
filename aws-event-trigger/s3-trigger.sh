...
# Setting AWS region and Bucket name
aws_region="us-east-1"
bucket_name="test-bucket-00000"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="pokalesumit5@gmail.com"
...
# Getting the role ARN from the JSON response and store it in a variable
...
# Creating a Zip file to upload Lambda Function
...
# Adding Permissions to S3 Bucket to invoke Lambda
...
# Creating an SNS topic and save the topic ARN to a variable
